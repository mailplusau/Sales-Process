...
define([
	...
	function pageInit() {
		...
		$("#applyFilter").click(function () {
			...
			var url =
				baseURL +
				"/app/site/hosting/scriptlet.nl?script=1886&deploy=1&sales_rep=" +
				sales_rep +
				"&zee=" +
				zee +
				"&campaign=" +
	...
	function loadDatatable(zee_id, userId) {
		...
		leadsListBySalesRepWeeklySearch
			...
			.each(function (prospectListBySalesRepWeeklyResultSet) {
				...
				var custStatus = prospectListBySalesRepWeeklyResultSet
					.getValue({
						name: "oldvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				var newCustStatus = prospectListBySalesRepWeeklyResultSet
					.getValue({
						name: "newvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				if (count1 == 0) {
					if (
						custStatus == "CUSTOMER-SIGNED(100%)" ||
						custStatus == "CUSTOMER-TO BE FINALISED"
					) {
						...
						if (newCustStatus == "SUSPECT-NEW") {
							...
							newCustStatus == "SUSPECT-VALIDATED" ||
							newCustStatus == "SUSPECT-OFF PEAK PIPELINE"
						) {
							//SUSPECT - VALIDATED
							suspect_validated = parseInt(prospectCount);
						} else if (
							newCustStatus == "SUSPECT-REP REASSIGN" ||
							newCustStatus == "SUSPECT-REASSIGN"
						) {
							...
							newCustStatus == "CUSTOMER-SIGNED(100%)" ||
							newCustStatus == "CUSTOMER-TO BE FINALISED"
						) {
							//CUSTOMER _ SIGNED
						...
						custStatus == "SUSPECT-REP REASSIGN" ||
						custStatus == "SUSPECT-REASSIGN"
					) {
						//SUSPECT - REP REASSIGN
						...
						custStatus == "SUSPECT-OFF PEAK PIPELINE"
					) {
						//SUSPECT - OFF PEAK PIPELINE
					...
					previousOldCustStatus != null &&
					previousOldCustStatus == custStatus
				) {
					if (
						previousOldCustStatus == "CUSTOMER-SIGNED(100%)" ||
						previousOldCustStatus == "CUSTOMER-TO BE FINALISED"
					) {
						//CUSTOMER _ SIGNED or CUSTOMER - TO BE FINALISED
						total_customer_signed += parseInt(prospectCount);
						if (newCustStatus == "SUSPECT-NEW") {
						...
						previousOldCustStatus == "SUSPECT-REP REASSIGN" ||
						previousOldCustStatus == "SUSPECT-REASSIGN"
					) {
						//SUSPECT - REP REASSIGN
						total_suspect_reassign += parseInt(prospectCount);
						if (newCustStatus == "SUSPECT-NEW") {
						...
						previousOldCustStatus == "SUSPECT-PARKING LOT" ||
						previousOldCustStatus == "SUSPECT-OFF PEAK PIPELINE"
					) {
						//SUSPECT - OFF PEAK PIPELINE
						total_suspect_off_peak_pipeline += parseInt(prospectCount);
						if (newCustStatus == "SUSPECT-NEW") {
					...
					if (
						...
						//CUSTOMER - FREE TRIAL
						debt_set2[18] = {
							title: "Customer - Pending Free Trial",
							suspect_new: suspect_new,
							suspect_hot_lead: suspect_hot_lead,
							suspect_qualified: suspect_qualified,
							suspect_validated: suspect_validated,
		...
		var dataTablePreview = $("#mpexusage-preview").DataTable({
			...
			footerCallback: function (row, data, start, end, display) {
				...
				// Update footer
				$(api.column(1).footer()).html(total_suspect_new);
				$(api.column(2).footer()).html(total_suspect_hot_lead);
				$(api.column(3).footer()).html(total_suspect_qualified);
				$(api.column(4).footer()).html(total_suspect_validated);
				$(api.column(5).footer()).html(total_suspect_reassign);
				$(api.column(6).footer()).html(total_suspect_followup);
				$(api.column(7).footer()).html(total_suspect_lpo_followup);
				$(api.column(8).footer()).html(total_suspect_no_answer);
				$(api.column(9).footer()).html(total_suspect_in_contact);
				$(api.column(10).footer()).html(total_prospect_in_contact);
				$(api.column(11).footer()).html(total_suspect_off_peak_pipeline);
				$(api.column(12).footer()).html(total_suspect_lost);
				$(api.column(13).footer()).html(total_suspect_oot);
				$(api.column(14).footer()).html(total_suspect_customer_lost);
				$(api.column(15).footer()).html(total_prospect_opportunity);
				$(api.column(16).footer()).html(total_prospect_qualified);
				$(api.column(17).footer()).html(total_prospect_quote_sent);

				$(api.column(18).footer()).html(total_customer_free_trial_pending);

				$(api.column(19).footer()).html(total_customer_free_trial);
				$(api.column(20).footer()).html(total_customer_signed);
				$(api.column(21).footer()).html(total_lead);
				$(api.column(22).footer()).html(total_lead_2);
			},
		});
		...
		if (!isNullorEmpty(leadStatus)) {
			console.log("inside leadStatus filter");
			leadsByCustomerWeeklySystemNotesSearch.filters.push(
				search.createFilter({
					name: "entitystatus",
					join: null,
					operator: search.Operator.IS,
		...
		var defaultSearchFilters =
			leadsByCustomerWeeklySystemNotesSearch.filterExpression;
		console.log(
			"signed customer defaultSearchFilters filters: " +
				JSON.stringify(defaultSearchFilters)
		);

		leadsByCustomerWeeklySystemNotesSearch
			.run()
			.each(function (leadsByCustomerWeeklySystemNotesSearchResultSet) {
				var customerId =
					leadsByCustomerWeeklySystemNotesSearchResultSet.getValue({
						name: "entityid",
						summary: "GROUP",
					});
				...
				var customerFranchiseeID =
					leadsByCustomerWeeklySystemNotesSearchResultSet.getValue({
						name: "partner",
						summary: "GROUP",
					});

				var customerFranchiseeText =
					leadsByCustomerWeeklySystemNotesSearchResultSet.getText({
						name: "partner",
						summary: "GROUP",
					});
				...
				var oldCustStatus = leadsByCustomerWeeklySystemNotesSearchResultSet
					.getValue({
						name: "oldvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				var newCustStatus = leadsByCustomerWeeklySystemNotesSearchResultSet
					.getValue({
						name: "newvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				if (count2 > 0 && oldCustomerId != customerId) {
					...
					if (
						oldCustomerStatusText.toUpperCase() == "CUSTOMER-SIGNED" ||
						oldCustomerStatusText.toUpperCase() == "CUSTOMER-TO BE FINALISED"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-HOT LEAD"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-OUT OF TERRITORY"
					) {
						suspect_oot.push({
							customerId: oldCustomerId,
							customerName: oldCustomerName,
						...
						oldCustomerStatusText.toUpperCase() ==
						"SUSPECT-CUSTOMER - LOSTSUSPECT-CUSTOMER - LOST"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-REP REASSIGN" ||
						oldCustomerStatusText.toUpperCase() == "SUSPECT-REASSIGN"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "PROSPECT-QUOTE SENT"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "PROSPECT-NO ANSWER"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "PROSPECT-IN CONTACT"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-PARKING LOT" ||
						oldCustomerStatusText.toUpperCase() == "SUSPECT-OFF PEAK PIPELINE"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "PROSPECT-OPPORTUNITY"
					) {
						suspect_off_peak_pipeline.push({
							customerId: oldCustomerId,
							customerName: oldCustomerName,
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-FOLLOW-UP"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-QUALIFIED"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-LPO FOLLOW-UP"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-VALIDATED"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "CUSTOMER-FREE TRIAL"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "CUSTOMER-FREE TRIAL PENDING"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-NO ANSWER"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "SUSPECT-IN CONTACT"
					) {
						...
						oldCustomerStatusText.toUpperCase() == "PROSPECT-QUALIFIED"
					) {
		...
		if (count2 > 0) {
			...
			if (
				...
				oldCustomerStatusText.toUpperCase() == "SUSPECT-CUSTOMER - LOST"
			) {
				suspect_customer_lost.push({
					customerId: oldCustomerId,
					customerName: oldCustomerName,
		...
		var dataTableCustomerList = $("#mpexusage-cust_list").DataTable({
			...
			rowCallback: function (row, data, index) {
				if (data[4] == "SUSPECT-Lost" || data[4] == "SUSPECT-Customer - Lost") {
					...
					data[4] == "CUSTOMER-To Be Finalised" ||
					data[4] == "CUSTOMER-Signed"
				) {
					if (data[5] == "YES") {
		...
		var dataTableByStatusCustomerList = $(
			"#mpexusage-status_cust_list"
		).DataTable({
			destroy: true,
			...
			rowCallback: function (row, data, index) {
				if (
					data[1] == "Suspect - Lost" ||
					data[1] == "Suspect - Customer - Lost"
				) {
					$("td", row).css("background-color", "#e97577");
				} else if (
					data[1] == "Customer - To Be Finalised" ||
					data[1] == "Customer - Signed"
				) {
					$("td", row).css("background-color", "#54bf9d");
		...
		$("#mpexusage-status_cust_list tbody").on(
			"click",
			"td.dt-control",
			function () {
				var tr = $(this).closest("tr");
		...
		if (!isNullorEmpty(leadStatus)) {
			console.log("inside leadStatus filter");
			leadsBySalesRepWeeklySystemNotesSearch.filters.push(
				search.createFilter({
					name: "entitystatus",
					join: null,
					operator: search.Operator.IS,
		...
		leadsBySalesRepWeeklySystemNotesSearch
			.run()
			.each(function (leadsBySalesRepWeeklySystemNotesSearchResultSet) {
				var prospectCount = parseInt(
					leadsBySalesRepWeeklySystemNotesSearchResultSet.getValue({
						name: "internalid",
						summary: "COUNT",
					})
				);
				...
				var systemNotesSetBy =
					leadsBySalesRepWeeklySystemNotesSearchResultSet.getText({
						name: "name",
						join: "systemNotes",
						summary: "GROUP",
					});

				var custStatus = leadsBySalesRepWeeklySystemNotesSearchResultSet
					.getValue({
						name: "oldvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				var newCustStatus = leadsBySalesRepWeeklySystemNotesSearchResultSet
					.getValue({
						name: "newvalue",
						join: "systemNotes",
						summary: "GROUP",
				...
				if (count3 == 0) {
					...
					if (
						oldSystemNotesStatus != null &&
						oldSystemNotesStatus == custStatus
					) {
						if (
							oldSystemNotesStatus == "CUSTOMER-SIGNED(100%)" ||
							oldSystemNotesStatus == "CUSTOMER-TO BE FINALISED"
						) {
							//CUSTOMER _ SIGNED or CUSTOMER - TO BE FINALISED
							total_customer_signed += parseInt(prospectCount);
							if (newCustStatus == "SUSPECT-NEW") {
							...
							oldSystemNotesStatus == "SUSPECT-REP REASSIGN" ||
							oldSystemNotesStatus == "SUSPECT-REASSIGN"
						) {
							//SUSPECT - REP REASSIGN
							total_suspect_reassign += parseInt(prospectCount);
							if (newCustStatus == "SUSPECT-NEW") {
							...
							oldSystemNotesStatus == "SUSPECT-PARKING LOT" ||
							oldSystemNotesStatus == "SUSPECT-OFF PEAK PIPELINE"
						) {
							//SUSPECT - OFF PEAK PIPELINE
							total_suspect_off_peak_pipeline += parseInt(prospectCount);
							if (newCustStatus == "SUSPECT-NEW") {
					...
					if (oldSystemNotesSetBy == "Aleyna A Harnett") {
						statusTransitionBySalesRepDataSet.push([
							"",
							"Aleyna A Harnett",
							totalLeadCountBySalesRep,
					...
					} else if (oldSystemNotesSetBy == "Jason Knowles") {
						statusTransitionBySalesRepDataSet.push([
							"",
							"Jason Knowles",
							totalLeadCountBySalesRep,
		...
		$("#mpexusage-sales_rep_list tbody").on(
			"click",
			"td.dt-control",
			function () {
				var tr = $(this).closest("tr");
	...
	function createSalesRepListTableChild(row) {
		...
		var usersTable = table.DataTable({
			...
			columns: [
				{
					title: "Transition From and To",
					className: "table-bg-color", //0
				},
				{
					title: "Suspect - New",
					className: "table-bg-color", //1
				},
				{
					title: "Suspect - Hot Lead",
					className: "table-bg-color", //2
				},
				{
					title: "Suspect - Qualified",
					className: "table-bg-color", //3
				},
				{
					title: "Suspect - Validated",
					className: "table-bg-color", //4
				},
				{
					title: "Suspect - Reassign",
					className: "table-bg-color", //5
				},
				{
					title: "Suspect - Follow Up",
					className: "table-bg-color", //6
				},
				{
					title: "Suspect - LPO Follow Up",
					className: "table-bg-color", //7
				},
				{
					title: "Suspect - No Answer",
					className: "table-bg-color", //8
				},
				{
					title: "Suspect - In Contact",
					className: "table-bg-color", //9
				},
				{
					title: "Prospect - No Answer",
					className: "table-bg-color", //10
				},
				{
					title: "Prospect - In Contact",
					className: "table-bg-color", //11
				},
				{
					title: "Suspect - Parking Lot",
					className: "table-bg-color", //12
				},
				{
					title: "Suspect - Lost",
					className: "table-bg-color", //13
				},
				{
					title: "Suspect - Out of Territory",
					className: "table-bg-color", //14
				},
				{
					title: "Suspect - Customer - Lost",
					className: "table-bg-color", //15
				},
				{
					title: "Prospect - Opportunity",
					className: "table-bg-color", //16
				},
				{
					title: "Prospect - Qualified",
					className: "table-bg-color", //17
				},
				{
					title: "Prospect - Quote Sent",
					className: "table-bg-color", //18
				},
				{
					title: "Customer - Free Trial Pending",
					className: "table-bg-color", //19
				},
				{
					title: "Customer - Free Trial",
					className: "table-bg-color", //20
				},
				{
					title: "Customer - Signed",
					className: "table-bg-color", //21
				},
			],
			columnDefs: [],
			rowCallback: function (row, data) {
