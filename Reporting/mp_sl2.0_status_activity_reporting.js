    ...
    function (moment, ui, email, runtime, search, record, https, log, redirect, url) {
        ...
        function onRequest(context) {
            ...
            if (context.request.method === 'GET') {
                ...
                form.clientScriptFileId = 7119023;
        ...
        function leadStatusDropdown(custStatus) {
            ...
            if (custStatus == '38') {
                inlineHtml += '<option value="38" selected>SUSPECT - UNQUALIFIED</option>';
            } else {
 ...
 */
        ...
        */
        ...
        function tabsSection() {
            ...
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-12"><div id="container_salesrep_overview"></div></div>';
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-6"><div id="container_entered_sales_rep_preview"></div></div>';
            inlineHtml += '<div class="col-xs-6"><div id="container_campaign_sales_rep_preview"></div></div>'
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '</figure><br></br>';
            ...
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-12"><div id="container_quoteSent_incontact_noanswer"></div></div>';
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-12"><div id="container_prospect_opportunity_last_assigned"></div></div>';
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-6"><div id="container_prospect_opportunity_source"></div></div>';
            inlineHtml += '<div class="col-xs-6"><div id="container_prospect_opportunity_campaign"></div></div>'
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '</figure><br></br>';
            ...
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-12"><div id="container_prospects_opportunites"></div></div>';
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-12"><div id="container_prospect_quote_sent_last_assigned"></div></div>';
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '<div class="">';
            inlineHtml += '<div class="row">';
            inlineHtml += '<div class="col-xs-6"><div id="container_prospect_quote_sent_source"></div></div>';
            inlineHtml += '<div class="col-xs-6"><div id="container_prospect_quote_sent_campaign"></div></div>'
            inlineHtml += '</div>';
            inlineHtml += '</div>';
            inlineHtml += '</figure><br></br>';
            ...
            // inlineHtml += '<div role="tabpanel" class="tab-pane" id="suspects_unqualified">';
            // inlineHtml += '<figure class="highcharts-figure">';
        ...
        function dataTable(name) {
            ...
            if (name == 'salesrep_overview') {
                inlineHtml += '<tfoot style="font-size: larger;"><tr style="background-color: #085c7b2e;border: 2px solid;"><th>TOTAL: </th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot>'
            }
