...
define([
	...
	function pageInit() {
		...
		$(".show_status_timeline").click(function () {
			...
			// Sales Dashboard - Lead Status Timeline
		...
		$(".show_salesrep_status_timeline").click(function () {
			...
			// Sales Dashboard - Lead Status Timeline - Grouped By Sales Rep
	...
	function loadDatatable(zee_id, userId) {
		...
		//Search Name: Sales Dashboard - Zee Lead by Status - System Notes - Weekly Reporting
		...
		// Sales Dashboard - Leads by Status - System Notes - Weekly Reporting
		...
		if (role != 1000 && (isNullorEmpty(lead_source) || lead_source == -4)) {
			...
			var dataTableZeePreview = $("#mpexusage-zee_overview").DataTable({
				...
				footerCallback: function (row, data, start, end, display) {
					...
					$(api.column(22).footer()).html(total_lead);
				},
			});
		...
		//Sales Dashboard - Leads by Status - System Notes - Data Capture Reporting
		...
		//Sales Dashboard - Leads by Source & Campaign - System Notes - Data Capture Reporting
		console.log(
		...
		//Sales Dashboard - Leads by Lead Entered - System Notes - Sales Rep Reporting
			...
			.each(function (leadsListBySalesRepDataCaptureCampaignSearchResultSet) {
				...
				if (count1 == 0) {
					...
					if (statusChangeSetById == statusChangeSetById) {
						...
						].details[0].enteredBy[enteredByLength - 1].count =
							total_leads_entered;
						salesRepAssignedTeam[
							salesRepAssignedTeam.length - 1
		...
		if (role != 1000 && (isNullorEmpty(lead_source) || lead_source == -4)) {
			//Sales Dashboard - Franchisee Generated Leads by System Notes Set By - Weekly Reporting
		...
		if (count > 0) {
			...
			console.log("customerCampaign: " + customerCampaign);
			if (customerCampaign.length > 0) {
				var newCampaign = true;
				for (var p = 0; p < customerCampaign.length; p++) {
					if (customerCampaign[p].id == currentCustCampaignId) {
		...
		// Sales Dashboard - Leads - Signed - System Notes Date Weekly Reporting
		var customerListBySalesRepWeeklySearch = search.load({
			type: "customer",
		...
		// Sales Dashboard - Leads - Trial - Last Assigned
		...
		//Sales Dashboard - Leads - Trial Pending - Last Assigned
		...
		// Sales Dashboard - Leads - Prospect Quote Sent - System Notes Date Weekly Reporting
	...
	function plotChartCustomerSignedCampaign(
		series_data30,
		series_data31,
		series_data32,
		series_data33,
