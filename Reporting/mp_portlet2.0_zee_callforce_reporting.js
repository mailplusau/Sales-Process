...
define([
	...
	function render(params) {
		...
		inlineHtml +=
			'<div class="container instruction_div " style="background-color: lightblue;font-size: 14px;padding: 15px;border-radius: 10px;border: 1px solid;box-shadow: 0px 1px 26px -10px white;"><p>This dashboard helps you track new customer leads and their progress over the last six months.</br></br><ol>Lead Workflow step-by-step:<li><b>Lead Review & Processing</b>: Initial processing of new leads & leads waiting to be reviewed by Business Owner.</li><li><b>Priority Inbound (Immediate Sales Action)</b>: Hot Website/Brochure leads sent to Account Managers. Turns RED if not actioned: Website (3 days), Brochure (7 days).</li><li><b>Field & Phone Inventory (Ready for Outreach)</b>: Ready for Prospect+ sync. These are handled by the outbound team as capacity allows (Lower priority).</li><li><b>Active Outreach (Engaged)</b>: Leads with established contact. Account Manager is actively moving these through the qualification process.</li><li><b>Qualified Pipeline</b>: Quotes sent, active free trials, or booked appointments from outbound/field team conversations.</li><li><b>Converted Customers</b>: Lead successfully converted to a signed customer.</li><li><b>Closed/Lost</b>: Leads marked as lost or placed in the \'Parking Lot\' for future re-engagement.</li></ol>Below are the Click the "<b>Full Report</b>" button for a detailed breakdown of your leads and opportunities.</p></br>';
