 ...
 * @Last modified time: 2021-11-19T11:55:15+11:00
 */
...
define(['N/ui/serverWidget', 'N/email', 'N/runtime', 'N/search', 'N/record',
  ...
  function(ui, email, runtime, search, record, http, log, redirect) {
    ...
    function onRequest(context) {
      ...
      if (context.request.method === 'GET') {
        ...
        var form = ui.createForm({
          title: 'MPEX Customers - Portal Training'
        });
        ...
        form.clientScriptFileId = 5321829;
    ...
    function updateCustomerModal() {
      ...
      var inlineHtml =
        '<div id="myModal" class="modal" style="display: none; position: fixed; z-index: 1; padding-top: 100px;left: 0;top: 0;width: 100%; height: 100%; overflow: auto; background-color: rgb(0,0,0); background-color: rgba(0,0,0,0.4); "><div class="modal-content" style="position: absolute;transform: translate(-50%, -50%);background-color: #fefefe;/* margin: auto; *//* padding: 0; */border: 1px solid #888;/* width: 80%; */left: 50%;top: 50%;/* box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2),0 6px 20px 0 rgba(0,0,0,0.19); */-webkit-animation-name: animatetop;-webkit-animation-duration: 0.4s;animation-name: animatetop;animation-duration: 0.4s;"><div class="modal-header" style="padding: 2px 16px;text-align: center;"><span class="close" style="color: black;float: right;font-size: 28px;font-weight: bold;"">&times;</span><h3 class="modal-title" id="modal-title">2-Week Call Notes</h3></div>';

      inlineHtml +=
        '<div class="modal-body" style="padding: 2px 16px;">';

      inlineHtml += '<div class="form-group container row_call_back">';
      inlineHtml += '<div class="row"><input type="text" id="task_id" value="" hidden/><input type="text" id="customer_id" value="" hidden/>';

      inlineHtml += '<div class="col-xs-4 date_section"><div class="input-group"><span class="input-group-addon">SET TRAINING DATE <span class="mandatory">*</span></span><input type="date" id="date" class="form-control" /></div></div>';
      inlineHtml += '<div class="col-xs-4 time_section"><div class="input-group"><span class="input-group-addon">SET TRAINING TIME <span class="mandatory">*</span></span><input type="time" id="time" class="form-control" /></div></div>';
      ...
      inlineHtml +=
        '</div><div class="modal-footer" style="padding: 2px 16px;"><input type="button" value="Schedule Training" class="form-control btn-primary" id="customerOnboardingCompleted" style=""/></div></div></div>';
