            ...
            if (!isNullorEmpty(debt_rows)) {
                debt_rows.forEach(function (debt_row, index) {
                    ...
                    debtDataSet.push(['', linkURL, debt_row.custInternalID,
                        ...
                        debt_row.phone, commDateFormatted, debt_row.email48h, debt_row.salesRepName, debt_row.dateFirstNoContact, debt_row.dateSecondNoContact, debt_row.dateThirdNoContact, debt_row.rowColorSort, debt_row.productUsageperWeek, sendSignUpEmail, debt_row.zeeMpExpActivated, debt_row.zeeMPStdActivated, debt_row.zeeMPPrmActivated, debt_row.child
                    ]);
                });
            }
            ...
            if (!isNullorEmpty(debt_rows4)) {
                debt_rows4.forEach(function (debt_row4, index) {
                    ...
                    debtDataSet4.push(['', linkURL, newDate, debt_row4.custInternalID,
                        ...
                        debt_row4.phone, debt_row4.servicesOfInterest, debt_row4.salesRepName, debt_row4.dateFirstNoContact, debt_row4.dateSecondNoContact, debt_row4.dateThirdNoContact, debt_row4.productUsageperWeek, sendSignUpEmail, debt_row4.zeeMpExpActivated, debt_row4.zeeMPStdActivated, debt_row4.zeeMPPrmActivated, debt_row4.child
                    ]);
                });
            }
